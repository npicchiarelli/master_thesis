...
\chapter{Introduction}
	...
	\cite{singh_pair_2024} studies what happens when two \ch{SiO2-Pt} Janus particles come together in different configurations; the authors take into account hydrodynamics and chemistry involved in the process, classifying the different possible cases.\todo{in che senso ne tengono conto?} 
	...
	The main fact, supported both by simulations and experimental evidence, we can use is that particles do not long-range reorientation due to hydrodynamic or chemical interaction, and that the leading interactions are steric and near-contact chemical.\todo{frase non chiara, riscrivere}
	...
	\cite{maity_spontaneous_2023} investigate what happens with a double population\todo{in che senso doppia?} of active colloidal particles. 
	...
	\end{figure}
	\todo{ma Jyoti l'ha letto questo articolo?}
