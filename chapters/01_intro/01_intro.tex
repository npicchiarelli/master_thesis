...
\chapter{Introduction}
	...
	{\color{blue}The first one to bring the concept of robotics at micro scale, especially for medical applications into a scientific context was Richard Feynman in the famous 1959 CalTech conference \citetitle{Feynman} \cite{Feynman}, from which the following quote is taken:
	\begin{displayquote}
	...
	When talking about microrobots \todo{articolo?}, we need to be clear about what a microrobot \emph{is}. 
	A \emph{robot} is \enquote{a machine that can perform a complicated series of tasks by itself} \citeauthor{robot_def_oxf}; a microrobot is defined as a robot with
	\begin{itemize}
	...
	Although not strictly related to the present work, \cite{cavagna_empirical_2010, ballerini_interaction_2008} are essential papers for the study of collective motion, for the problem of relating theoretical models and reality is tackled analyzing videos of starling swarms in order to understand characteristics of interactions. \todo{non capisco questa frase}
