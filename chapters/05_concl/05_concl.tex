...
Inserting a threshold range in interactions allowed to lighten\todo{lighten sembra una traduzione letterale dall'italiano... esprimiti meglio} the simulation, resulting in reduced execution times, as well as simulating topological interactions and study the effect that interaction range have on the system.
...
As stated in section \ref{3concl} this would put this kind of system in the set of \todo{manca un pezzo...}
...
\todo{concludi con quello che il mondo delle particelle attive/sistemi complessi guadagna da questo lavoro}
