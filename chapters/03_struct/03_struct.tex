...
\begin{document}
	...
	Our investigation in structure and dynamics is based upon a small yet descriptive set of tools that help unveiling how particles spatially organize and how they move.
		...
		\subsection{Global and Local Polarization}
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_velocity/situa10.0_oc0.5.png}}
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_velocity/situa20.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_velocity/situa10.0_oc-0.5.png}}
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_velocity/situa20.0_oc-0.5.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/polar10.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/polar20.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/polar10.0_oc-0.5.png}}\\
		...
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/polar20.0_oc-0.5.png}}
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/cluster10.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/cluster20.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/cluster10.0_oc-0.5.png}}\\
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			...
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/cluster20.0_oc-0.5.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/rdf10.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/rdf20.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/rdf10.0_oc-0.5.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_velocity/rdf20.0_oc-0.5.png}}\\
		...
		\begin{figure}[htp]
			\centering\
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_vdist/situa1.0.png}}
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_vdist/situa2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_vdist/situa5.0.png}}
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_vdist/situa10.0.png}}\\
		...
		\begin{figure}[htp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/polar1.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/polar2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/polar5.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/polar10.0.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/cluster1.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/cluster2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/cluster5.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}[t]
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/cluster10.0.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/rdf1.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/rdf2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/rdf5.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_vdist/rdf10.0.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_oc/situa-0.75.png}}
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_oc/situa-0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_oc/situa-0.25.png}}
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_oc/situa0.0.png}}\\
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_oc/situa0.25.png}}
			\subfloat[][]{\includegraphics[width=.5\textwidth]{lj_oc/situa0.5.png}}\\
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}[t]
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/polar-0.75.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/polar-0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/polar-0.25.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}[hbtp]
			\ContinuedFloat
			\centering
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/polar0.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/polar0.25.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/polar0.5.png}}\\
			\caption[]{}
		\end{figure}
		...
		\begin{figure}[t]
			...
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/polar0.75.png}}
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/cluster-0.75.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/cluster-0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/cluster-0.25.png}}\\
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
			\begin{figure}[hbtp]
				\ContinuedFloat
				\centering
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/cluster0.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/cluster0.25.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/cluster0.5.png}}\\
			%\captionsetup{list=false}
			\caption[]{}
			\end{figure}
			\begin{figure}[t]
				\ContinuedFloat
				\centering
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/cluster0.75.png}}
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/rdf-0.75.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/rdf-0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/rdf-0.25.png}}
			\caption[]{}
		\end{figure}
		\begin{figure}\ContinuedFloat
			\centering
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/rdf0.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/rdf0.25.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/rdf0.5.png}}\\
			\caption[]{}
		\end{figure}
		\begin{figure}\ContinuedFloat
			\centering
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_oc/rdf0.75.png}}
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/polar0.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/polar0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/polar1.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
		\centering
		\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/polar2.0.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/cluster0.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/cluster0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/cluster1.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
		\centering
		\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/cluster2.0.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/rdf0.0.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/rdf0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/rdf1.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}[t]
		\centering
		\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.8\textwidth]{lj_av/rdf2.0.png}}\\
