...
\begin{document}
	...
	Our investigation in structure and dynamics is based upon a small yet descriptive set of tools that help unveiling how particles spatially organize and how they move.
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/polar10.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/polar20.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/polar10.0_oc-0.5.png}}\\
		...
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/polar20.0_oc-0.5.png}}
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/cluster10.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/cluster20.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/cluster10.0_oc-0.5.png}}\\
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			...
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/cluster20.0_oc-0.5.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/rdf10.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/rdf20.0_oc0.5.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/rdf10.0_oc-0.5.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_velocity/rdf20.0_oc-0.5.png}}\\
		...
		\begin{figure}[htp]
			\centering\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/polar1.0.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/polar2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/polar5.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/polar10.0.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/cluster1.0.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/cluster2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/cluster5.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}[t]
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/cluster10.0.png}}\\
		...
		\begin{figure}[hbtp]
			\centering\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/rdf1.0.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/rdf2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/rdf5.0.png}}
			%\captionsetup{list=false}
			\caption[]{}
		\end{figure}
		\begin{figure}
			\centering
			\ContinuedFloat
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/rdf10.0.png}}\\
