...
\begin{document}
	...
	Our investigation in structure and dynamics is based upon a small yet descriptive set of tools that help unveiling how particles spatially organize and how they move.
		...
		\begin{figure}[htp]
			\centering\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/situa1.0.png}}
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/situa2.0.png}}\\
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/situa5.0.png}}
			\subfloat[][]{\includegraphics[width=.9\textwidth]{lj_vdist/situa10.0.png}}\\
