...
\label{chap:int_impl}
	...
	We will not go through all of them, but briefly, open boundary conditions means just doing nothing\todo{esprimiti meglio}, while a hard wall involves computing boundary's gradient in any point and using it as a locally straight wall condition.
	...
	\label{hs}
	Interactions among particles were\todo{erano quando? nel codice originale? confermo che è meglio anticipare questa sezione} steric hard sphere correction, which are enough to study clustering, MIPS and boundary accumulation.
	...
	This long collision time encouraged us to implement inelastic collision, where adhesion forces keep particles together after the impact.\todo{noi non è che abbiamo delle forze di adesione...}
