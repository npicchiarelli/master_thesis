...
\begin{document}
	...
	We worked with two different potentials, elastic and Lennard Jones, in order to show how the characteristic of interaction, especially its range change network's prediction accuracy.
